            ...
            {mode !== "forgot" && (
              <div className="mt-6 space-y-3">
                <button
                  ...
                  className="group relative flex h-12 w-full items-center justify-center gap-3 overflow-hidden rounded-xl border border-border/70 bg-background/60 font-semibold text-foreground backdrop-blur transition hover:border-primary/50 hover:bg-background/80 disabled:opacity-70"
                >
                  {googleLoading ? (
                      ...
                      <div className="flex-1">
                        <FieldShell icon={<Phone className="h-4 w-4" />}>
                          <Input
                            ...
                            className="h-12 w-full border-0 bg-transparent pl-10 focus-visible:ring-0"
                          />
                        </FieldShell>
                      </div>
                    </div>
